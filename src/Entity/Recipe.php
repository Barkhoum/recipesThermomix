...
class Recipe
{
    ...
    #[ORM\Column(type: 'string', nullable:'null')]
...
private ?float $average = null;
    ...
    public function getNbsPersonnes(): ?int
    {
        return $this->nbsPersonnes;
    }

    public function setNbsPersonnes(?int $nbsPersonnes): self
    {
        $this->nbsPersonnes = $nbsPersonnes;
