...
class Menu
{
    ...
    #[ORM\ManyToOne(targetEntity: Categoryarticles::class, inversedBy: 'menus')]
    private $category;
    ...
    public function getCategory(): ?Categoryarticles
    {
        return $this->category;
    }

    public function setCategory(?Categoryarticles $category): self
    {
